...
mcp = FastMCP("weatherMcp", dependencies=["requests"],host="127.0.0.1", port=9002)
...
def get_current_weather(province: str, city: str) -> str:
    """查询当地的天气的工具。如果用户的问题中有省、市、区等字样，记得返回的参数不要出现省、市、区等字样。举例：用户问上海市宝山区的天气，你返回上海宝山就行了；用户问浙江省金华市的天气，你返回浙江金华就行了。
    如果用户问金华的天气，你也返回浙江金华，自动把省补全。"""
    ...
    cityMap = {
        ...
        "浙江杭州": "101210101", "浙江宁波": "101210401", "浙江温州": "101210701", "浙江绍兴": "101210501",
        "浙江台州": "101210601", "浙江丽水": "101210801", "浙江舟山": "101210301", "浙江湖州": "101210201",
        "浙江嘉兴": "101210301", "浙江衢州": "101210801", "浙江金华": "101210901", 
    }
...
if __name__ == "__main__":
    print("🚀 启动MCP天气服务器...")
    print("📍 服务地址: http://127.0.0.1:9002")
    print("🔧 可用工具: get_current_weather")
    # 使用新的运行方式
